...
class TestSedimentSizeSample(unittest.TestCase):
    ...
    def test_add(self):
        ...
        first_sample = SedimentSample(1, size_distribution=[[0.01, 0.1], [0., 1.]])
        second_sample = SedimentSample(1, size_distribution=[[0.01, 0.1], [0., 1.]])

        third_sample = first_sample.add(second_sample)

        self.assertEqual(first_sample.size_distribution(), first_sample.size_distribution())
    ...
    def test_add_raises(self):
        ...
        second_sample = SedimentSample(2, size_distribution=second_distribution)

        self.assertRaisesRegex(ValueError, "Size distributions must have equivalent diameter arrays",
